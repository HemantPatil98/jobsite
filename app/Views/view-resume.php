					...
					<ul class="job-meta tr-list list-inline">
						...
						<li>
							...
							><a href="#"
								><span
									class="__cf_email__"
									data-cfemail="b9d3d1d6d7ddd6dcf9ded4d8d0d597dad6d4"
			...
			<div class="container">
				<div class="section">
					<ul class="tr-list resume-info">
						...
						<li class="qualification media">
							...
							<div class="media-body">
								...
								<ol>
									<li>
										5 years+ experience designing and building products In the
										Design & IT industry.
									</li>
						...
						<li class="personal-deatils media">
							...
							<div class="media-body">
								...
								<ul class="tr-list">
									...
									<li>
										<span class="left">Sex</span><span class="middle">:</span>
									...
									<li>
										...
										><span class="middle">:</span>
										<span class="right"
											>121 King Street, Melbourne Victoria, 1200 USA</span
										>
									</li>
								</ul>
							</div>
					...
					<div class="buttons pull-right">
						<a href="#" class="btn button-send"
							><i class="fa fa-envelope-o" aria-hidden="true"></i>Send Email</a
						>
