			...
			<div class="container">
				<div class="breadcrumb-info text-center">
					...
					<ul class="tr-list job-meta list-inline">
						<li>
							<i class="fa fa-map-signs" aria-hidden="true"></i>San Francisco,
							CA, US
						</li>
						<li>
							<i class="fa fa-map-marker" aria-hidden="true"></i>Full Time
						</li>
						<li>
							<i class="fa fa-money" aria-hidden="true"></i>$25,000 - $35,000
						</li>
						<li>
							<i class="fa fa-tags" aria-hidden="true"></i>HR/Org. Development
						</li>
						<li>
					...
					<div class="buttons">
						<a href="#" class="btn btn-primary"
							...
							Job</a
						>
						<a href="#" class="btn button-bookmark"
							><i class="fa fa-bookmark" aria-hidden="true"></i>Bookmark</a
						>
						<span class="btn button-share"
					...
					<div class="col-md-8 col-lg-9">
						<div class="job-summary section">
							...
							<p>
								...
								social media advertisements, client collateral & digital resizes
								according to Client demands With direction of the Creative team,
								input into new design ideas for client branding Update & keep
								all agency collateral materials, including keeping records of
								Client's logos, fonts, images, etc.
							</p>
									...
									<ul class="tr-list">
										...
										<li>
											...
											<a href="#"
												><span
													class="__cf_email__"
													data-cfemail="127b7c747d5276607d62707d6a3c717d7f"
								...
								<div class="item-overlay">
									<div class="job-info">
										...
										<ul class="tr-list job-meta">
											<li>
												<i class="fa fa-map-signs" aria-hidden="true"></i>San
												Francisco, CA, US
											</li>
											<li>
												<i class="fa fa-briefcase" aria-hidden="true"></i>Mid
												Level
											</li>
											<li>
